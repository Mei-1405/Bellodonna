...
import {View,Text, StatusBar, Image, Button, Pressable} from "native-base";
// import {SafeAreaView, StyleSheet} form "react-native";
  ...
  return(
    <View style={styles.Container}>
      ...
      <View style={{alignItems:"center",}}>
        {/* <Image source={require('./Assets/Img/illus.png')} style={{height:250,width:300,top:30,alignSelf:"center"}} /> */}
